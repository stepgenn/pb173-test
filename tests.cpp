...
TEST_CASE("remove_padding","function test") {
	...
	unsigned char str2[16] = {0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x03,0x03,0x03,0x03};
	CHECK(remove_padding(str2,16)== 3);
}
